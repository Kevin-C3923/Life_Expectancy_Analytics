...
The new dataset wil be generated from the original dataset with the specific characteristics, which will be used to create a database in PostgreSQL and hosted in Amazon Web Services. PG Admin shall be used for editing and connection to the DB.
